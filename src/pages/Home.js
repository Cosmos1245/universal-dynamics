...
import india from '/home/cosmos/project-z/src/india.png';
import mail from '/home/cosmos/project-z/src/gmail.png';
import linkedin from '/home/cosmos/project-z/src/linkedin.png';
import github from '/home/cosmos/project-z/src/github.png';
    ...
    return (
        <div>
            ...
            <div className="d-flex flex-row">
                ...
                <h3>Sports Car</h3>
                    <img className="car-image" src={items[25].image_url}/>    
                </div>
                <div className="car-item"  style={{margin:'12px'}}>
                 <h3>Vintage Cars</h3>
                    <img className="car-image" src={items[44].image_url}/>    
                </div>
                <div className="car-item"  style={{margin:'12px'}}>
                 <h3>E-Vehicles</h3>
                    <img className="car-image" src={items[18].image_url}/>    
                </div>
                 </div>
