 ...
 <Router>
            <div>
                <nav className={`navbar navbar-expand-lg ${theme === 'Dark Theme' ? 'bg-dark navbar-dark' : 'navbar-light'}`}>
                    ...
                    <a className="navbar-brand" style={{ position: "relative" }} id="ud-brand">UD</a>
<a className="navbar-brand" style={{ position: "relative" }} id="universal-brand">Universal Dynamics</a>
